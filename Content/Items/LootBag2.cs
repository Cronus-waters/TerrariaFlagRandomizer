...
namespace TerrariaFlagRandomizer.Content.Items
{
	...
	{
        public override string Texture => TerrariaFlagRandomizer.AssetPath + "Images/Items/LootBag2";
		...
		public override void ModifyItemLoot(ItemLoot itemLoot)
		{
			...
			itemLoot.Add(new OneFromRulesRule(1, TieredItemSets.PostSkeletronBars));

			// Progressive Material rule
			itemLoot.Add(new OneFromRulesRule(1, TieredItemSets.PostSkeletronMaterials));

			// Build Progressive Weapons rules
			List<IItemDropRule> weaponRulesList = new List<IItemDropRule>();
			foreach (int id in TieredItemSets.PostSkeletronWeapons)
			{
