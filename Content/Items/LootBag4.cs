...
namespace TerrariaFlagRandomizer.Content.Items
{
	...
	{
        public override string Texture => TerrariaFlagRandomizer.AssetPath + "Images/Items/LootBag4";
		...
		public override void ModifyItemLoot(ItemLoot itemLoot)
		{
			...
			itemLoot.Add(new OneFromRulesRule(1, TieredItemSets.PostMechBars));

			// Progressive Material rule
			itemLoot.Add(new OneFromRulesRule(1, TieredItemSets.PostMechMaterials));

			// Build Progressive Weapons rules
			List<IItemDropRule> weaponRulesList = new List<IItemDropRule>();
			foreach (int id in TieredItemSets.PostMechWeapons)
			{
