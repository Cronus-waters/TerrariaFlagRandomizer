...
namespace TerrariaFlagRandomizer.Content.Items
{
	internal class LootBag6 : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot)
		{
			...
			itemLoot.Add(new OneFromRulesRule(1, TieredItemSets.PostGolemBars));

			// Progressive Material rule
			itemLoot.Add(new OneFromRulesRule(1, TieredItemSets.PostGolemMaterials));

			// Build Progressive Weapons rules
			List<IItemDropRule> weaponRulesList = new List<IItemDropRule>();
			foreach (int id in TieredItemSets.PostGolemWeapons)
			{
